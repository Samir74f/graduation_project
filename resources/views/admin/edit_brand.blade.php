...
@endif
    ...
    <div class="card-header">Edit brand {{$data->name}} </div>
@include('sweetalert::alert')
<form enctype="multipart/form-data" method="POST" action="{{url('Update_brand/'.$data->id)}}">
    @method ('Put')
    @csrf
        ...
        <div class="row gutters  mb-3">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="text-right ">
                    ...
                    <button type="submit" id="submit" name="submit" class="btn btn-primary">Update brand</button>
                </div>
            </div>
        </div>
</form>
